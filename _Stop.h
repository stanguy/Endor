...
extern const struct StopAttributes {
	...
	__unsafe_unretained NSString *bike_count;
	__unsafe_unretained NSString *lat;
	__unsafe_unretained NSString *line_count;
	__unsafe_unretained NSString *lon;
	__unsafe_unretained NSString *metro_count;
	__unsafe_unretained NSString *name;
	__unsafe_unretained NSString *old_src_id;
	__unsafe_unretained NSString *pos_count;
...
extern const struct StopRelationships {
	...
	__unsafe_unretained NSString *close_pois;
	__unsafe_unretained NSString *lines;
	__unsafe_unretained NSString *stop_aliases;
...
@property (nonatomic, strong) NSNumber* bike_count;
...
@property (nonatomic, strong) NSNumber* line_count;
...
@property (nonatomic, strong) NSNumber* metro_count;
...
@property (nonatomic, strong) NSNumber* pos_count;
...
@property (nonatomic, strong) NSSet *close_pois;
...
@property (nonatomic, strong) NSSet *stop_aliases;
