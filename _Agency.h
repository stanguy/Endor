...
extern const struct AgencyAttributes {
	__unsafe_unretained NSString *ads_allowed;
	__unsafe_unretained NSString *city;
	__unsafe_unretained NSString *feed_ref;
	__unsafe_unretained NSString *feed_url;
} AgencyAttributes;
...
@property (nonatomic, strong) NSNumber* ads_allowed;
...
@property (nonatomic, strong) NSString* feed_ref;
