...
extern const struct GTFSCalendarRelationships {
	__unsafe_unretained NSString *calendar_dates;
	__unsafe_unretained NSString *stoptimes;
...
@property (nonatomic, strong) NSSet *calendar_dates;
...
@property (nonatomic, strong) NSSet *stoptimes;
